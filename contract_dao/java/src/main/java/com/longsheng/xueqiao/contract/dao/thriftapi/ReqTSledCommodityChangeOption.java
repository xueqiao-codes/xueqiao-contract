...
public class ReqTSledCommodityChangeOption implements org.apache.thrift.TBase<ReqTSledCommodityChangeOption, ReqTSledCommodityChangeOption._Fields>, java.io.Serializable, Cloneable, Comparable<ReqTSledCommodityChangeOption> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ReqTSledCommodityChangeOption");
  ...
  static {
    schemes.put(StandardScheme.class, new ReqTSledCommodityChangeOptionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ReqTSledCommodityChangeOptionTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ReqTSledCommodityChangeOption.class, metaDataMap);
  }

  public ReqTSledCommodityChangeOption() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public ReqTSledCommodityChangeOption(ReqTSledCommodityChangeOption other) {
  ...
  public ReqTSledCommodityChangeOption deepCopy() {
    return new ReqTSledCommodityChangeOption(this);
  }
  ...
  public ReqTSledCommodityChangeOption setSledCommodityIds(List<Integer> sledCommodityIds) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ReqTSledCommodityChangeOption)
      return this.equals((ReqTSledCommodityChangeOption)that);
    return false;
  }

  public boolean equals(ReqTSledCommodityChangeOption that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ReqTSledCommodityChangeOption other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ReqTSledCommodityChangeOption(");
    boolean first = true;
  ...
  private static class ReqTSledCommodityChangeOptionStandardSchemeFactory implements SchemeFactory {
    public ReqTSledCommodityChangeOptionStandardScheme getScheme() {
      return new ReqTSledCommodityChangeOptionStandardScheme();
    }
  }

  private static class ReqTSledCommodityChangeOptionStandardScheme extends StandardScheme<ReqTSledCommodityChangeOption> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ReqTSledCommodityChangeOption struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sledCommodityIds = new ArrayList<Integer>(_list208.size);
                for (int _i209 = 0; _i209 < _list208.size; ++_i209)
                {
                  int _elem210;
                  _elem210 = iprot.readI32();
                  struct.sledCommodityIds.add(_elem210);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReqTSledCommodityChangeOption struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.sledCommodityIds != null) {
        if (struct.isSetSledCommodityIds()) {
          oprot.writeFieldBegin(SLED_COMMODITY_IDS_FIELD_DESC);
          {
            ...
            for (int _iter211 : struct.sledCommodityIds)
            {
  ...
  private static class ReqTSledCommodityChangeOptionTupleSchemeFactory implements SchemeFactory {
    public ReqTSledCommodityChangeOptionTupleScheme getScheme() {
      return new ReqTSledCommodityChangeOptionTupleScheme();
    }
  }

  private static class ReqTSledCommodityChangeOptionTupleScheme extends TupleScheme<ReqTSledCommodityChangeOption> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ReqTSledCommodityChangeOption struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetSledCommodityIds()) {
        {
          ...
          for (int _iter212 : struct.sledCommodityIds)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ReqTSledCommodityChangeOption struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.sledCommodityIds = new ArrayList<Integer>(_list213.size);
          for (int _i214 = 0; _i214 < _list213.size; ++_i214)
          {
            int _elem215;
            _elem215 = iprot.readI32();
            struct.sledCommodityIds.add(_elem215);
          }
        }
        struct.setSledCommodityIdsIsSet(true);
      }
