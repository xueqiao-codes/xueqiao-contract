            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mapIds = new ArrayList<Integer>(_list80.size);
                for (int _i81 = 0; _i81 < _list80.size; ++_i81)
                {
                  int _elem82;
                  _elem82 = iprot.readI32();
                  struct.mapIds.add(_elem82);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sledCommodityIds = new ArrayList<Integer>(_list83.size);
      ...
      if (struct.sledCommodityIds != null) {
        if (struct.isSetSledCommodityIds()) {
          oprot.writeFieldBegin(SLED_COMMODITY_IDS_FIELD_DESC);
          {
            ...
            for (int _iter87 : struct.sledCommodityIds)
            {
      ...
      if (struct.isSetSledCommodityIds()) {
        {
          ...
          for (int _iter89 : struct.sledCommodityIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.mapIds = new ArrayList<Integer>(_list90.size);
          for (int _i91 = 0; _i91 < _list90.size; ++_i91)
          {
            int _elem92;
            _elem92 = iprot.readI32();
            struct.mapIds.add(_elem92);
          }
        }
        struct.setMapIdsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.sledCommodityIds = new ArrayList<Integer>(_list93.size);
