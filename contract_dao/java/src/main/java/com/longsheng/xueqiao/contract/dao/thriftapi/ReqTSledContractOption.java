            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sledContractIds = new ArrayList<Integer>(_list128.size);
                for (int _i129 = 0; _i129 < _list128.size; ++_i129)
                {
                  int _elem130;
                  _elem130 = iprot.readI32();
                  struct.sledContractIds.add(_elem130);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.sledContractIds != null) {
        if (struct.isSetSledContractIds()) {
          oprot.writeFieldBegin(SLED_CONTRACT_IDS_FIELD_DESC);
          {
            ...
            for (int _iter131 : struct.sledContractIds)
            {
      ...
      if (struct.isSetSledContractIds()) {
        {
          ...
          for (int _iter132 : struct.sledContractIds)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.sledContractIds = new ArrayList<Integer>(_list133.size);
          for (int _i134 = 0; _i134 < _list133.size; ++_i134)
          {
            int _elem135;
            _elem135 = iprot.readI32();
            struct.sledContractIds.add(_elem135);
          }
        }
        struct.setSledContractIdsIsSet(true);
      }
