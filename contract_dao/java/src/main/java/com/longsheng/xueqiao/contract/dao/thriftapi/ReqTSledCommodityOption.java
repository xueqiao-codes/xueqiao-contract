            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sledCommodityIds = new ArrayList<Integer>(_list112.size);
                for (int _i113 = 0; _i113 < _list112.size; ++_i113)
                {
                  int _elem114;
                  _elem114 = iprot.readI32();
                  struct.sledCommodityIds.add(_elem114);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.sledCommodityIds != null) {
        if (struct.isSetSledCommodityIds()) {
          oprot.writeFieldBegin(SLED_COMMODITY_IDS_FIELD_DESC);
          {
            ...
            for (int _iter115 : struct.sledCommodityIds)
            {
      ...
      if (struct.isSetSledCommodityIds()) {
        {
          ...
          for (int _iter116 : struct.sledCommodityIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.sledCommodityIds = new ArrayList<Integer>(_list117.size);
          for (int _i118 = 0; _i118 < _list117.size; ++_i118)
          {
            int _elem119;
            _elem119 = iprot.readI32();
            struct.sledCommodityIds.add(_elem119);
          }
        }
        struct.setSledCommodityIdsIsSet(true);
      }
