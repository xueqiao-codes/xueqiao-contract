            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.relateCommodityIds = new ArrayList<Integer>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  int _elem2;
                  _elem2 = iprot.readI32();
                  struct.relateCommodityIds.add(_elem2);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sledCommodityConfig = new ArrayList<String>(_list3.size);
                for (int _i4 = 0; _i4 < _list3.size; ++_i4)
                {
                  String _elem5;
                  _elem5 = iprot.readString();
                  struct.sledCommodityConfig.add(_elem5);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.relateCommodityIds != null) {
        if (struct.isSetRelateCommodityIds()) {
          oprot.writeFieldBegin(RELATE_COMMODITY_IDS_FIELD_DESC);
          {
            ...
            for (int _iter6 : struct.relateCommodityIds)
            {
      ...
      if (struct.sledCommodityConfig != null) {
        if (struct.isSetSledCommodityConfig()) {
          oprot.writeFieldBegin(SLED_COMMODITY_CONFIG_FIELD_DESC);
          {
            ...
            for (String _iter7 : struct.sledCommodityConfig)
            {
      ...
      if (struct.isSetRelateCommodityIds()) {
        {
          ...
          for (int _iter8 : struct.relateCommodityIds)
          {
      ...
      if (struct.isSetSledCommodityConfig()) {
        {
          ...
          for (String _iter9 : struct.sledCommodityConfig)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.relateCommodityIds = new ArrayList<Integer>(_list10.size);
          for (int _i11 = 0; _i11 < _list10.size; ++_i11)
          {
            int _elem12;
            _elem12 = iprot.readI32();
            struct.relateCommodityIds.add(_elem12);
          }
        }
        struct.setRelateCommodityIdsIsSet(true);
      }
      ...
      if (incoming.get(18)) {
        {
          ...
          struct.sledCommodityConfig = new ArrayList<String>(_list13.size);
          for (int _i14 = 0; _i14 < _list13.size; ++_i14)
          {
            String _elem15;
            _elem15 = iprot.readString();
            struct.sledCommodityConfig.add(_elem15);
          }
        }
        struct.setSledCommodityConfigIsSet(true);
      }
