            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sledExchangeIds = new ArrayList<Integer>(_list160.size);
                for (int _i161 = 0; _i161 < _list160.size; ++_i161)
                {
                  int _elem162;
                  _elem162 = iprot.readI32();
                  struct.sledExchangeIds.add(_elem162);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.sledExchangeIds != null) {
        if (struct.isSetSledExchangeIds()) {
          oprot.writeFieldBegin(SLED_EXCHANGE_IDS_FIELD_DESC);
          {
            ...
            for (int _iter163 : struct.sledExchangeIds)
            {
      ...
      if (struct.isSetSledExchangeIds()) {
        {
          ...
          for (int _iter164 : struct.sledExchangeIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.sledExchangeIds = new ArrayList<Integer>(_list165.size);
          for (int _i166 = 0; _i166 < _list165.size; ++_i166)
          {
            int _elem167;
            _elem167 = iprot.readI32();
            struct.sledExchangeIds.add(_elem167);
          }
        }
        struct.setSledExchangeIdsIsSet(true);
      }
