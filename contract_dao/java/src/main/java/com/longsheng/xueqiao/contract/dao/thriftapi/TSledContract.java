            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.relateContractIds = new ArrayList<Integer>(_list48.size);
                for (int _i49 = 0; _i49 < _list48.size; ++_i49)
                {
                  int _elem50;
                  _elem50 = iprot.readI32();
                  struct.relateContractIds.add(_elem50);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.relateContractIds != null) {
        if (struct.isSetRelateContractIds()) {
          oprot.writeFieldBegin(RELATE_CONTRACT_IDS_FIELD_DESC);
          {
            ...
            for (int _iter51 : struct.relateContractIds)
            {
      ...
      if (struct.isSetRelateContractIds()) {
        {
          ...
          for (int _iter52 : struct.relateContractIds)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.relateContractIds = new ArrayList<Integer>(_list53.size);
          for (int _i54 = 0; _i54 < _list53.size; ++_i54)
          {
            int _elem55;
            _elem55 = iprot.readI32();
            struct.relateContractIds.add(_elem55);
          }
        }
        struct.setRelateContractIdsIsSet(true);
      }
