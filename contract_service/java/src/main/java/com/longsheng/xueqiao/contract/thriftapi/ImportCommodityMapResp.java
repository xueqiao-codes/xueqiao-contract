            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.existMapping = new ArrayList<String>(_list80.size);
                for (int _i81 = 0; _i81 < _list80.size; ++_i81)
                {
                  String _elem82;
                  _elem82 = iprot.readString();
                  struct.existMapping.add(_elem82);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.conflictMapping = new ArrayList<String>(_list83.size);
                for (int _i84 = 0; _i84 < _list83.size; ++_i84)
                {
                  String _elem85;
                  _elem85 = iprot.readString();
                  struct.conflictMapping.add(_elem85);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.addMapping = new ArrayList<String>(_list86.size);
                for (int _i87 = 0; _i87 < _list86.size; ++_i87)
                {
                  String _elem88;
                  _elem88 = iprot.readString();
                  struct.addMapping.add(_elem88);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.existMapping != null) {
        if (struct.isSetExistMapping()) {
          oprot.writeFieldBegin(EXIST_MAPPING_FIELD_DESC);
          {
            ...
            for (String _iter89 : struct.existMapping)
            {
      ...
      if (struct.conflictMapping != null) {
        if (struct.isSetConflictMapping()) {
          oprot.writeFieldBegin(CONFLICT_MAPPING_FIELD_DESC);
          {
            ...
            for (String _iter90 : struct.conflictMapping)
            {
      ...
      if (struct.addMapping != null) {
        if (struct.isSetAddMapping()) {
          oprot.writeFieldBegin(ADD_MAPPING_FIELD_DESC);
          {
            ...
            for (String _iter91 : struct.addMapping)
            {
      ...
      if (struct.isSetExistMapping()) {
        {
          ...
          for (String _iter92 : struct.existMapping)
          {
      ...
      if (struct.isSetConflictMapping()) {
        {
          ...
          for (String _iter93 : struct.conflictMapping)
          {
      ...
      if (struct.isSetAddMapping()) {
        {
          ...
          for (String _iter94 : struct.addMapping)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.existMapping = new ArrayList<String>(_list95.size);
          for (int _i96 = 0; _i96 < _list95.size; ++_i96)
          {
            String _elem97;
            _elem97 = iprot.readString();
            struct.existMapping.add(_elem97);
          }
        }
        struct.setExistMappingIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.conflictMapping = new ArrayList<String>(_list98.size);
          for (int _i99 = 0; _i99 < _list98.size; ++_i99)
          {
            String _elem100;
            _elem100 = iprot.readString();
            struct.conflictMapping.add(_elem100);
          }
        }
        struct.setConflictMappingIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.addMapping = new ArrayList<String>(_list101.size);
          for (int _i102 = 0; _i102 < _list101.size; ++_i102)
          {
            String _elem103;
            _elem103 = iprot.readString();
            struct.addMapping.add(_elem103);
          }
        }
        struct.setAddMappingIsSet(true);
      }
