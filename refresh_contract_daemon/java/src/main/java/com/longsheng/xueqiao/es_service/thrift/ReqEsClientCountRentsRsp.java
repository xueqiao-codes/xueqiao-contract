...
public class ReqEsClientCountRentsRsp implements org.apache.thrift.TBase<ReqEsClientCountRentsRsp, ReqEsClientCountRentsRsp._Fields>, java.io.Serializable, Cloneable, Comparable<ReqEsClientCountRentsRsp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ReqEsClientCountRentsRsp");
  ...
  static {
    schemes.put(StandardScheme.class, new ReqEsClientCountRentsRspStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ReqEsClientCountRentsRspTupleSchemeFactory());
  }

  public int total; // optional
  public int pageIndex; // optional
  public int pageCount; // optional
  public List<EsClientCountRent> page; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.PAGE, new org.apache.thrift.meta_data.FieldMetaData("page", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, EsClientCountRent.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ReqEsClientCountRentsRsp.class, metaDataMap);
  }

  public ReqEsClientCountRentsRsp() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public ReqEsClientCountRentsRsp(ReqEsClientCountRentsRsp other) {
    __isset_bitfield = other.__isset_bitfield;
    this.total = other.total;
    this.pageIndex = other.pageIndex;
    this.pageCount = other.pageCount;
    if (other.isSetPage()) {
      List<EsClientCountRent> __this__page = new ArrayList<EsClientCountRent>(other.page.size());
      for (EsClientCountRent other_element : other.page) {
        __this__page.add(new EsClientCountRent(other_element));
      }
      this.page = __this__page;
    }
  }

  public ReqEsClientCountRentsRsp deepCopy() {
    return new ReqEsClientCountRentsRsp(this);
  }
  ...
  public ReqEsClientCountRentsRsp setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public ReqEsClientCountRentsRsp setPageIndex(int pageIndex) {
  ...
  public ReqEsClientCountRentsRsp setPageCount(int pageCount) {
  ...
  public java.util.Iterator<EsClientCountRent> getPageIterator() {
    return (this.page == null) ? null : this.page.iterator();
  }

  public void addToPage(EsClientCountRent elem) {
    if (this.page == null) {
      this.page = new ArrayList<EsClientCountRent>();
    }
    this.page.add(elem);
  }

  public List<EsClientCountRent> getPage() {
    return this.page;
  }

  public ReqEsClientCountRentsRsp setPage(List<EsClientCountRent> page) {
    this.page = page;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PAGE:
      if (value == null) {
        ...
        setPage((List<EsClientCountRent>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ReqEsClientCountRentsRsp)
      return this.equals((ReqEsClientCountRentsRsp)that);
    return false;
  }

  public boolean equals(ReqEsClientCountRentsRsp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ReqEsClientCountRentsRsp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ReqEsClientCountRentsRsp(");
    boolean first = true;
  ...
  private static class ReqEsClientCountRentsRspStandardSchemeFactory implements SchemeFactory {
    public ReqEsClientCountRentsRspStandardScheme getScheme() {
      return new ReqEsClientCountRentsRspStandardScheme();
    }
  }

  private static class ReqEsClientCountRentsRspStandardScheme extends StandardScheme<ReqEsClientCountRentsRsp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ReqEsClientCountRentsRsp struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.page = new ArrayList<EsClientCountRent>(_list104.size);
                for (int _i105 = 0; _i105 < _list104.size; ++_i105)
                {
                  EsClientCountRent _elem106;
                  _elem106 = new EsClientCountRent();
                  _elem106.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReqEsClientCountRentsRsp struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.page != null) {
        if (struct.isSetPage()) {
          oprot.writeFieldBegin(PAGE_FIELD_DESC);
          {
            ...
            for (EsClientCountRent _iter107 : struct.page)
            {
  ...
  private static class ReqEsClientCountRentsRspTupleSchemeFactory implements SchemeFactory {
    public ReqEsClientCountRentsRspTupleScheme getScheme() {
      return new ReqEsClientCountRentsRspTupleScheme();
    }
  }

  private static class ReqEsClientCountRentsRspTupleScheme extends TupleScheme<ReqEsClientCountRentsRsp> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ReqEsClientCountRentsRsp struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetPage()) {
        {
          ...
          for (EsClientCountRent _iter108 : struct.page)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ReqEsClientCountRentsRsp struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.page = new ArrayList<EsClientCountRent>(_list109.size);
          for (int _i110 = 0; _i110 < _list109.size; ++_i110)
          {
            EsClientCountRent _elem111;
            _elem111 = new EsClientCountRent();
            _elem111.read(iprot);
