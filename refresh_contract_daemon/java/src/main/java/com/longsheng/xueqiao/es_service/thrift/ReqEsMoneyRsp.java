...
public class ReqEsMoneyRsp implements org.apache.thrift.TBase<ReqEsMoneyRsp, ReqEsMoneyRsp._Fields>, java.io.Serializable, Cloneable, Comparable<ReqEsMoneyRsp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ReqEsMoneyRsp");
  ...
  static {
    schemes.put(StandardScheme.class, new ReqEsMoneyRspStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ReqEsMoneyRspTupleSchemeFactory());
  }

  public int total; // optional
  public int pageIndex; // optional
  public int pageCount; // optional
  public List<EsMoneyQryRspField> page; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.PAGE, new org.apache.thrift.meta_data.FieldMetaData("page", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, EsMoneyQryRspField.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ReqEsMoneyRsp.class, metaDataMap);
  }

  public ReqEsMoneyRsp() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public ReqEsMoneyRsp(ReqEsMoneyRsp other) {
    __isset_bitfield = other.__isset_bitfield;
    this.total = other.total;
    this.pageIndex = other.pageIndex;
    this.pageCount = other.pageCount;
    if (other.isSetPage()) {
      List<EsMoneyQryRspField> __this__page = new ArrayList<EsMoneyQryRspField>(other.page.size());
      for (EsMoneyQryRspField other_element : other.page) {
        __this__page.add(new EsMoneyQryRspField(other_element));
      }
      this.page = __this__page;
    }
  }

  public ReqEsMoneyRsp deepCopy() {
    return new ReqEsMoneyRsp(this);
  }
  ...
  public ReqEsMoneyRsp setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public ReqEsMoneyRsp setPageIndex(int pageIndex) {
  ...
  public ReqEsMoneyRsp setPageCount(int pageCount) {
  ...
  public java.util.Iterator<EsMoneyQryRspField> getPageIterator() {
    return (this.page == null) ? null : this.page.iterator();
  }

  public void addToPage(EsMoneyQryRspField elem) {
    if (this.page == null) {
      this.page = new ArrayList<EsMoneyQryRspField>();
    }
    this.page.add(elem);
  }

  public List<EsMoneyQryRspField> getPage() {
    return this.page;
  }

  public ReqEsMoneyRsp setPage(List<EsMoneyQryRspField> page) {
    this.page = page;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PAGE:
      if (value == null) {
        ...
        setPage((List<EsMoneyQryRspField>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ReqEsMoneyRsp)
      return this.equals((ReqEsMoneyRsp)that);
    return false;
  }

  public boolean equals(ReqEsMoneyRsp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ReqEsMoneyRsp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ReqEsMoneyRsp(");
    boolean first = true;
  ...
  private static class ReqEsMoneyRspStandardSchemeFactory implements SchemeFactory {
    public ReqEsMoneyRspStandardScheme getScheme() {
      return new ReqEsMoneyRspStandardScheme();
    }
  }

  private static class ReqEsMoneyRspStandardScheme extends StandardScheme<ReqEsMoneyRsp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ReqEsMoneyRsp struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.page = new ArrayList<EsMoneyQryRspField>(_list136.size);
                for (int _i137 = 0; _i137 < _list136.size; ++_i137)
                {
                  EsMoneyQryRspField _elem138;
                  _elem138 = new EsMoneyQryRspField();
                  _elem138.read(iprot);
                  struct.page.add(_elem138);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReqEsMoneyRsp struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.page != null) {
        if (struct.isSetPage()) {
          oprot.writeFieldBegin(PAGE_FIELD_DESC);
          {
            ...
            for (EsMoneyQryRspField _iter139 : struct.page)
            {
  ...
  private static class ReqEsMoneyRspTupleSchemeFactory implements SchemeFactory {
    public ReqEsMoneyRspTupleScheme getScheme() {
      return new ReqEsMoneyRspTupleScheme();
    }
  }

  private static class ReqEsMoneyRspTupleScheme extends TupleScheme<ReqEsMoneyRsp> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ReqEsMoneyRsp struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetPage()) {
        {
          ...
          for (EsMoneyQryRspField _iter140 : struct.page)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ReqEsMoneyRsp struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.page = new ArrayList<EsMoneyQryRspField>(_list141.size);
          for (int _i142 = 0; _i142 < _list141.size; ++_i142)
          {
            EsMoneyQryRspField _elem143;
            _elem143 = new EsMoneyQryRspField();
            _elem143.read(iprot);
            struct.page.add(_elem143);
          }
        }
        struct.setPageIsSet(true);
      }
