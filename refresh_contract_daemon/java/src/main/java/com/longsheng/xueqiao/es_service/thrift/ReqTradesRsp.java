...
public class ReqTradesRsp implements org.apache.thrift.TBase<ReqTradesRsp, ReqTradesRsp._Fields>, java.io.Serializable, Cloneable, Comparable<ReqTradesRsp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ReqTradesRsp");
  ...
  static {
    schemes.put(StandardScheme.class, new ReqTradesRspStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ReqTradesRspTupleSchemeFactory());
  }

  public int total; // optional
  public int pageIndex; // optional
  public int pageCount; // optional
  public List<EsTradeField> page; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.PAGE, new org.apache.thrift.meta_data.FieldMetaData("page", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, EsTradeField.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ReqTradesRsp.class, metaDataMap);
  }
   ...
   */
  public ReqTradesRsp(ReqTradesRsp other) {
    __isset_bitfield = other.__isset_bitfield;
    this.total = other.total;
    this.pageIndex = other.pageIndex;
    this.pageCount = other.pageCount;
    if (other.isSetPage()) {
      List<EsTradeField> __this__page = new ArrayList<EsTradeField>(other.page.size());
      for (EsTradeField other_element : other.page) {
        __this__page.add(new EsTradeField(other_element));
      }
      this.page = __this__page;
    }
  }

  public ReqTradesRsp deepCopy() {
    return new ReqTradesRsp(this);
  }
  ...
  public ReqTradesRsp setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public ReqTradesRsp setPageIndex(int pageIndex) {
  ...
  public ReqTradesRsp setPageCount(int pageCount) {
  ...
  public java.util.Iterator<EsTradeField> getPageIterator() {
    return (this.page == null) ? null : this.page.iterator();
  }

  public void addToPage(EsTradeField elem) {
    if (this.page == null) {
      this.page = new ArrayList<EsTradeField>();
    }
    this.page.add(elem);
  }

  public List<EsTradeField> getPage() {
    return this.page;
  }

  public ReqTradesRsp setPage(List<EsTradeField> page) {
    this.page = page;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PAGE:
      if (value == null) {
        ...
        setPage((List<EsTradeField>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ReqTradesRsp)
      return this.equals((ReqTradesRsp)that);
    return false;
  }

  public boolean equals(ReqTradesRsp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ReqTradesRsp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ReqTradesRsp(");
    boolean first = true;
  ...
  private static class ReqTradesRspStandardSchemeFactory implements SchemeFactory {
    public ReqTradesRspStandardScheme getScheme() {
      return new ReqTradesRspStandardScheme();
    }
  }

  private static class ReqTradesRspStandardScheme extends StandardScheme<ReqTradesRsp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ReqTradesRsp struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.page = new ArrayList<EsTradeField>(_list264.size);
                for (int _i265 = 0; _i265 < _list264.size; ++_i265)
                {
                  EsTradeField _elem266;
                  _elem266 = new EsTradeField();
                  _elem266.read(iprot);
                  struct.page.add(_elem266);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReqTradesRsp struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.page != null) {
        if (struct.isSetPage()) {
          oprot.writeFieldBegin(PAGE_FIELD_DESC);
          {
            ...
            for (EsTradeField _iter267 : struct.page)
            {
  ...
  private static class ReqTradesRspTupleSchemeFactory implements SchemeFactory {
    public ReqTradesRspTupleScheme getScheme() {
      return new ReqTradesRspTupleScheme();
    }
  }

  private static class ReqTradesRspTupleScheme extends TupleScheme<ReqTradesRsp> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ReqTradesRsp struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetPage()) {
        {
          ...
          for (EsTradeField _iter268 : struct.page)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ReqTradesRsp struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.page = new ArrayList<EsTradeField>(_list269.size);
          for (int _i270 = 0; _i270 < _list269.size; ++_i270)
          {
            EsTradeField _elem271;
            _elem271 = new EsTradeField();
            _elem271.read(iprot);
            struct.page.add(_elem271);
          }
        }
        struct.setPageIsSet(true);
      }
