...
public class ReqEsHoldsRsp implements org.apache.thrift.TBase<ReqEsHoldsRsp, ReqEsHoldsRsp._Fields>, java.io.Serializable, Cloneable, Comparable<ReqEsHoldsRsp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ReqEsHoldsRsp");
  ...
  static {
    schemes.put(StandardScheme.class, new ReqEsHoldsRspStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ReqEsHoldsRspTupleSchemeFactory());
  }

  public int total; // optional
  public int pageIndex; // optional
  public int pageCount; // optional
  public List<EsHoldField> page; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.PAGE, new org.apache.thrift.meta_data.FieldMetaData("page", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, EsHoldField.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ReqEsHoldsRsp.class, metaDataMap);
  }

  public ReqEsHoldsRsp() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public ReqEsHoldsRsp(ReqEsHoldsRsp other) {
    __isset_bitfield = other.__isset_bitfield;
    this.total = other.total;
    this.pageIndex = other.pageIndex;
    this.pageCount = other.pageCount;
    if (other.isSetPage()) {
      List<EsHoldField> __this__page = new ArrayList<EsHoldField>(other.page.size());
      for (EsHoldField other_element : other.page) {
        __this__page.add(new EsHoldField(other_element));
      }
      this.page = __this__page;
    }
  }

  public ReqEsHoldsRsp deepCopy() {
    return new ReqEsHoldsRsp(this);
  }
  ...
  public ReqEsHoldsRsp setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public ReqEsHoldsRsp setPageIndex(int pageIndex) {
  ...
  public ReqEsHoldsRsp setPageCount(int pageCount) {
  ...
  public java.util.Iterator<EsHoldField> getPageIterator() {
    return (this.page == null) ? null : this.page.iterator();
  }

  public void addToPage(EsHoldField elem) {
    if (this.page == null) {
      this.page = new ArrayList<EsHoldField>();
    }
    this.page.add(elem);
  }

  public List<EsHoldField> getPage() {
    return this.page;
  }

  public ReqEsHoldsRsp setPage(List<EsHoldField> page) {
    this.page = page;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PAGE:
      if (value == null) {
        ...
        setPage((List<EsHoldField>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ReqEsHoldsRsp)
      return this.equals((ReqEsHoldsRsp)that);
    return false;
  }

  public boolean equals(ReqEsHoldsRsp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ReqEsHoldsRsp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ReqEsHoldsRsp(");
    boolean first = true;
  ...
  private static class ReqEsHoldsRspStandardSchemeFactory implements SchemeFactory {
    public ReqEsHoldsRspStandardScheme getScheme() {
      return new ReqEsHoldsRspStandardScheme();
    }
  }

  private static class ReqEsHoldsRspStandardScheme extends StandardScheme<ReqEsHoldsRsp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ReqEsHoldsRsp struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.page = new ArrayList<EsHoldField>(_list200.size);
                for (int _i201 = 0; _i201 < _list200.size; ++_i201)
                {
                  EsHoldField _elem202;
                  _elem202 = new EsHoldField();
                  _elem202.read(iprot);
                  struct.page.add(_elem202);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReqEsHoldsRsp struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.page != null) {
        if (struct.isSetPage()) {
          oprot.writeFieldBegin(PAGE_FIELD_DESC);
          {
            ...
            for (EsHoldField _iter203 : struct.page)
            {
  ...
  private static class ReqEsHoldsRspTupleSchemeFactory implements SchemeFactory {
    public ReqEsHoldsRspTupleScheme getScheme() {
      return new ReqEsHoldsRspTupleScheme();
    }
  }

  private static class ReqEsHoldsRspTupleScheme extends TupleScheme<ReqEsHoldsRsp> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ReqEsHoldsRsp struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetPage()) {
        {
          ...
          for (EsHoldField _iter204 : struct.page)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ReqEsHoldsRsp struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.page = new ArrayList<EsHoldField>(_list205.size);
          for (int _i206 = 0; _i206 < _list205.size; ++_i206)
          {
            EsHoldField _elem207;
            _elem207 = new EsHoldField();
            _elem207.read(iprot);
            struct.page.add(_elem207);
          }
        }
        struct.setPageIsSet(true);
      }
