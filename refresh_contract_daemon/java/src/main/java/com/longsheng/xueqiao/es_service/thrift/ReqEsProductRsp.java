...
public class ReqEsProductRsp implements org.apache.thrift.TBase<ReqEsProductRsp, ReqEsProductRsp._Fields>, java.io.Serializable, Cloneable, Comparable<ReqEsProductRsp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ReqEsProductRsp");
  ...
  static {
    schemes.put(StandardScheme.class, new ReqEsProductRspStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ReqEsProductRspTupleSchemeFactory());
  }

  public int total; // optional
  public int pageIndex; // optional
  public int pageCount; // optional
  public List<EsProduct> page; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.PAGE, new org.apache.thrift.meta_data.FieldMetaData("page", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, EsProduct.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ReqEsProductRsp.class, metaDataMap);
  }

  public ReqEsProductRsp() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public ReqEsProductRsp(ReqEsProductRsp other) {
    __isset_bitfield = other.__isset_bitfield;
    this.total = other.total;
    this.pageIndex = other.pageIndex;
    this.pageCount = other.pageCount;
    if (other.isSetPage()) {
      List<EsProduct> __this__page = new ArrayList<EsProduct>(other.page.size());
      for (EsProduct other_element : other.page) {
        __this__page.add(new EsProduct(other_element));
      }
      this.page = __this__page;
    }
  }

  public ReqEsProductRsp deepCopy() {
    return new ReqEsProductRsp(this);
  }
  ...
  public ReqEsProductRsp setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public ReqEsProductRsp setPageIndex(int pageIndex) {
  ...
  public ReqEsProductRsp setPageCount(int pageCount) {
  ...
  public java.util.Iterator<EsProduct> getPageIterator() {
    return (this.page == null) ? null : this.page.iterator();
  }

  public void addToPage(EsProduct elem) {
    if (this.page == null) {
      this.page = new ArrayList<EsProduct>();
    }
    this.page.add(elem);
  }

  public List<EsProduct> getPage() {
    return this.page;
  }

  public ReqEsProductRsp setPage(List<EsProduct> page) {
    this.page = page;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ReqEsProductRsp)
      return this.equals((ReqEsProductRsp)that);
    return false;
  }

  public boolean equals(ReqEsProductRsp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ReqEsProductRsp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ReqEsProductRsp(");
    boolean first = true;
  ...
  private static class ReqEsProductRspStandardSchemeFactory implements SchemeFactory {
    public ReqEsProductRspStandardScheme getScheme() {
      return new ReqEsProductRspStandardScheme();
    }
  }

  private static class ReqEsProductRspStandardScheme extends StandardScheme<ReqEsProductRsp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ReqEsProductRsp struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.page = new ArrayList<EsProduct>(_list72.size);
                for (int _i73 = 0; _i73 < _list72.size; ++_i73)
                {
                  EsProduct _elem74;
                  _elem74 = new EsProduct();
                  _elem74.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReqEsProductRsp struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.page != null) {
        if (struct.isSetPage()) {
          oprot.writeFieldBegin(PAGE_FIELD_DESC);
          {
            ...
            for (EsProduct _iter75 : struct.page)
            {
              _iter75.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class ReqEsProductRspTupleSchemeFactory implements SchemeFactory {
    public ReqEsProductRspTupleScheme getScheme() {
      return new ReqEsProductRspTupleScheme();
    }
  }

  private static class ReqEsProductRspTupleScheme extends TupleScheme<ReqEsProductRsp> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ReqEsProductRsp struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetPage()) {
        {
          ...
          for (EsProduct _iter76 : struct.page)
          {
            _iter76.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ReqEsProductRsp struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.page = new ArrayList<EsProduct>(_list77.size);
          for (int _i78 = 0; _i78 < _list77.size; ++_i78)
          {
            EsProduct _elem79;
            _elem79 = new EsProduct();
            _elem79.read(iprot);
