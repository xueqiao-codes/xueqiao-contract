...
public class QuotationTopic implements org.apache.thrift.TBase<QuotationTopic, QuotationTopic._Fields>, java.io.Serializable, Cloneable, Comparable<QuotationTopic> {
  ...
  private static final org.apache.thrift.protocol.TField PLATFORM_STR_FIELD_DESC = new org.apache.thrift.protocol.TField("platformStr", org.apache.thrift.protocol.TType.STRING, (short)1);
  ...
  private _Fields optionals[] = {_Fields.PLATFORM_STR,_Fields.CONTRACT_SYMBOL};
  public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
  static {
    Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
    tmpMap.put(_Fields.PLATFORM_STR, new org.apache.thrift.meta_data.FieldMetaData("platformStr", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public QuotationTopic(QuotationTopic other) {
    if (other.isSetPlatformStr()) {
      this.platformStr = other.platformStr;
    }
  ...
  public QuotationTopic setPlatformStr(String platformStr) {
    this.platformStr = platformStr;
    return this;
  }

  public void unsetPlatformStr() {
    this.platformStr = null;
  }

  /** Returns true if field platformStr is set (has been assigned a value) and false otherwise */
  public boolean isSetPlatformStr() {
    return this.platformStr != null;
  }

  public void setPlatformStrIsSet(boolean value) {
    if (!value) {
      this.platformStr = null;
    }
  }
  ...
  public boolean equals(QuotationTopic that) {
    ...
    boolean this_present_platformStr = true && this.isSetPlatformStr();
    boolean that_present_platformStr = true && that.isSetPlatformStr();
    if (this_present_platformStr || that_present_platformStr) {
      if (!(this_present_platformStr && that_present_platformStr))
        return false;
      if (!this.platformStr.equals(that.platformStr))
        return false;
    }
  ...
  public int compareTo(QuotationTopic other) {
    ...
    lastComparison = Boolean.valueOf(isSetPlatformStr()).compareTo(other.isSetPlatformStr());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPlatformStr()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.platformStr, other.platformStr);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class QuotationTopicStandardScheme extends StandardScheme<QuotationTopic> {
        ...
        switch (schemeField.id) {
          case 1: // PLATFORM_STR
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.platformStr = iprot.readString();
              struct.setPlatformStrIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QuotationTopic struct) throws org.apache.thrift.TException {
      ...
      if (struct.platformStr != null) {
        if (struct.isSetPlatformStr()) {
          oprot.writeFieldBegin(PLATFORM_STR_FIELD_DESC);
          oprot.writeString(struct.platformStr);
          oprot.writeFieldEnd();
        }
      }
