...
/**
 * 3,4,5,6,7根据平台接口返回进行约定
 * 8 根据托管机本身环境配置决定
 */
public class PlatformContract implements org.apache.thrift.TBase<PlatformContract, PlatformContract._Fields>, java.io.Serializable, Cloneable, Comparable<PlatformContract> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PlatformContract");
  ...
  private static final org.apache.thrift.protocol.TField CONTRACT_CODE_FIELD_DESC = new org.apache.thrift.protocol.TField("contractCode", org.apache.thrift.protocol.TType.STRING, (short)6);
  private static final org.apache.thrift.protocol.TField EXTEND_CONTRACT_CODE_FIELD_DESC = new org.apache.thrift.protocol.TField("extendContractCode", org.apache.thrift.protocol.TType.LIST, (short)7);
  ...
  static {
    schemes.put(StandardScheme.class, new PlatformContractStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PlatformContractTupleSchemeFactory());
  }
  ...
  public List<String> extendContractCode; // optional
  /**
   * 
   * @see PlatformEnv
   */
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    CONTRACT_CODE((short)6, "contractCode"),
    EXTEND_CONTRACT_CODE((short)7, "extendContractCode"),
    /**
     * 
     * @see PlatformEnv
     */
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 6: // CONTRACT_CODE
          return CONTRACT_CODE;
        case 7: // EXTEND_CONTRACT_CODE
          return EXTEND_CONTRACT_CODE;
        case 8: // PLATFORM_ENV
          return PLATFORM_ENV;
        default:
          return null;
  ...
  private _Fields optionals[] = {_Fields.CONTRACT_ID,_Fields.PLATFORM,_Fields.EXCHANGE,_Fields.COMMODITY_TYPE,_Fields.COMMODITY_CODE,_Fields.CONTRACT_CODE,_Fields.EXTEND_CONTRACT_CODE,_Fields.PLATFORM_ENV};
  ...
  static {
    ...
    tmpMap.put(_Fields.CONTRACT_CODE, new org.apache.thrift.meta_data.FieldMetaData("contractCode", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.EXTEND_CONTRACT_CODE, new org.apache.thrift.meta_data.FieldMetaData("extendContractCode", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PlatformContract.class, metaDataMap);
  }
   ...
   */
  public PlatformContract(PlatformContract other) {
    ...
    if (other.isSetExtendContractCode()) {
      List<String> __this__extendContractCode = new ArrayList<String>(other.extendContractCode);
      this.extendContractCode = __this__extendContractCode;
    }
  ...
  public PlatformContract deepCopy() {
    return new PlatformContract(this);
  }
  ...
  public PlatformContract setContractId(int contractId) {
   ...
   * @see Platform
   */
  public PlatformContract setPlatform(Platform platform) {
  ...
  public PlatformContract setExchange(String exchange) {
  ...
  public PlatformContract setCommodityType(String commodityType) {
  ...
  public PlatformContract setCommodityCode(String commodityCode) {
  ...
  public PlatformContract setContractCode(String contractCode) {
  ...
  public int getExtendContractCodeSize() {
    return (this.extendContractCode == null) ? 0 : this.extendContractCode.size();
  }

  public java.util.Iterator<String> getExtendContractCodeIterator() {
    return (this.extendContractCode == null) ? null : this.extendContractCode.iterator();
  }

  public void addToExtendContractCode(String elem) {
    if (this.extendContractCode == null) {
      this.extendContractCode = new ArrayList<String>();
    }
    this.extendContractCode.add(elem);
  }

  public List<String> getExtendContractCode() {
    return this.extendContractCode;
  }

  public PlatformContract setExtendContractCode(List<String> extendContractCode) {
    this.extendContractCode = extendContractCode;
    return this;
  }

  public void unsetExtendContractCode() {
    this.extendContractCode = null;
  }

  /** Returns true if field extendContractCode is set (has been assigned a value) and false otherwise */
  public boolean isSetExtendContractCode() {
    return this.extendContractCode != null;
  }

  public void setExtendContractCodeIsSet(boolean value) {
    if (!value) {
      this.extendContractCode = null;
    }
  }
   ...
   * @see PlatformEnv
   */
  public PlatformContract setPlatformEnv(PlatformEnv platformEnv) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case EXTEND_CONTRACT_CODE:
      if (value == null) {
        unsetExtendContractCode();
      } else {
        setExtendContractCode((List<String>)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case EXTEND_CONTRACT_CODE:
      return isSetExtendContractCode();
    case PLATFORM_ENV:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PlatformContract)
      return this.equals((PlatformContract)that);
    return false;
  }

  public boolean equals(PlatformContract that) {
    if (that == null)
      return false;
    ...
    boolean this_present_extendContractCode = true && this.isSetExtendContractCode();
    boolean that_present_extendContractCode = true && that.isSetExtendContractCode();
    if (this_present_extendContractCode || that_present_extendContractCode) {
      if (!(this_present_extendContractCode && that_present_extendContractCode))
        return false;
      if (!this.extendContractCode.equals(that.extendContractCode))
        return false;
    }
  ...
  @Override
  public int compareTo(PlatformContract other) {
    ...
    lastComparison = Boolean.valueOf(isSetExtendContractCode()).compareTo(other.isSetExtendContractCode());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExtendContractCode()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.extendContractCode, other.extendContractCode);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PlatformContract(");
    boolean first = true;
    ...
    if (isSetExtendContractCode()) {
      if (!first) sb.append(", ");
      sb.append("extendContractCode:");
      if (this.extendContractCode == null) {
        sb.append("null");
      } else {
        sb.append(this.extendContractCode);
      }
      first = false;
    }
    if (isSetPlatformEnv()) {
  ...
  private static class PlatformContractStandardSchemeFactory implements SchemeFactory {
    public PlatformContractStandardScheme getScheme() {
      return new PlatformContractStandardScheme();
    }
  }

  private static class PlatformContractStandardScheme extends StandardScheme<PlatformContract> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PlatformContract struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.extendContractCode = new ArrayList<String>(_list56.size);
                for (int _i57 = 0; _i57 < _list56.size; ++_i57)
                {
                  String _elem58;
                  _elem58 = iprot.readString();
                  struct.extendContractCode.add(_elem58);
                }
                iprot.readListEnd();
              }
              struct.setExtendContractCodeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PlatformContract struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.extendContractCode != null) {
        if (struct.isSetExtendContractCode()) {
          oprot.writeFieldBegin(EXTEND_CONTRACT_CODE_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, struct.extendContractCode.size()));
            for (String _iter59 : struct.extendContractCode)
            {
  ...
  private static class PlatformContractTupleSchemeFactory implements SchemeFactory {
    public PlatformContractTupleScheme getScheme() {
      return new PlatformContractTupleScheme();
    }
  }

  private static class PlatformContractTupleScheme extends TupleScheme<PlatformContract> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PlatformContract struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetExtendContractCode()) {
        {
          oprot.writeI32(struct.extendContractCode.size());
          for (String _iter60 : struct.extendContractCode)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PlatformContract struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.extendContractCode = new ArrayList<String>(_list61.size);
          for (int _i62 = 0; _i62 < _list61.size; ++_i62)
          {
            String _elem63;
            _elem63 = iprot.readString();
            struct.extendContractCode.add(_elem63);
          }
        }
        struct.setExtendContractCodeIsSet(true);
      }
