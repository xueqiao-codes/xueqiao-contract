...
public class ReqOrdersRsp implements org.apache.thrift.TBase<ReqOrdersRsp, ReqOrdersRsp._Fields>, java.io.Serializable, Cloneable, Comparable<ReqOrdersRsp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ReqOrdersRsp");
  ...
  static {
    schemes.put(StandardScheme.class, new ReqOrdersRspStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ReqOrdersRspTupleSchemeFactory());
  }

  public int total; // optional
  public int pageIndex; // optional
  public int pageCount; // optional
  public List<EsOrderStatusField> page; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.PAGE, new org.apache.thrift.meta_data.FieldMetaData("page", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, EsOrderStatusField.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ReqOrdersRsp.class, metaDataMap);
  }
   ...
   */
  public ReqOrdersRsp(ReqOrdersRsp other) {
    __isset_bitfield = other.__isset_bitfield;
    this.total = other.total;
    this.pageIndex = other.pageIndex;
    this.pageCount = other.pageCount;
    if (other.isSetPage()) {
      List<EsOrderStatusField> __this__page = new ArrayList<EsOrderStatusField>(other.page.size());
      for (EsOrderStatusField other_element : other.page) {
        __this__page.add(new EsOrderStatusField(other_element));
      }
      this.page = __this__page;
    }
  }

  public ReqOrdersRsp deepCopy() {
    return new ReqOrdersRsp(this);
  }
  ...
  public ReqOrdersRsp setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
  ...
  public ReqOrdersRsp setPageIndex(int pageIndex) {
  ...
  public ReqOrdersRsp setPageCount(int pageCount) {
  ...
  public java.util.Iterator<EsOrderStatusField> getPageIterator() {
    return (this.page == null) ? null : this.page.iterator();
  }

  public void addToPage(EsOrderStatusField elem) {
    if (this.page == null) {
      this.page = new ArrayList<EsOrderStatusField>();
    }
    this.page.add(elem);
  }

  public List<EsOrderStatusField> getPage() {
    return this.page;
  }

  public ReqOrdersRsp setPage(List<EsOrderStatusField> page) {
    this.page = page;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PAGE:
      if (value == null) {
        ...
        setPage((List<EsOrderStatusField>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ReqOrdersRsp)
      return this.equals((ReqOrdersRsp)that);
    return false;
  }

  public boolean equals(ReqOrdersRsp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ReqOrdersRsp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ReqOrdersRsp(");
    boolean first = true;
  ...
  private static class ReqOrdersRspStandardSchemeFactory implements SchemeFactory {
    public ReqOrdersRspStandardScheme getScheme() {
      return new ReqOrdersRspStandardScheme();
    }
  }

  private static class ReqOrdersRspStandardScheme extends StandardScheme<ReqOrdersRsp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ReqOrdersRsp struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.page = new ArrayList<EsOrderStatusField>(_list232.size);
                for (int _i233 = 0; _i233 < _list232.size; ++_i233)
                {
                  EsOrderStatusField _elem234;
                  _elem234 = new EsOrderStatusField();
                  _elem234.read(iprot);
                  struct.page.add(_elem234);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReqOrdersRsp struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.page != null) {
        if (struct.isSetPage()) {
          oprot.writeFieldBegin(PAGE_FIELD_DESC);
          {
            ...
            for (EsOrderStatusField _iter235 : struct.page)
            {
  ...
  private static class ReqOrdersRspTupleSchemeFactory implements SchemeFactory {
    public ReqOrdersRspTupleScheme getScheme() {
      return new ReqOrdersRspTupleScheme();
    }
  }

  private static class ReqOrdersRspTupleScheme extends TupleScheme<ReqOrdersRsp> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ReqOrdersRsp struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetPage()) {
        {
          ...
          for (EsOrderStatusField _iter236 : struct.page)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ReqOrdersRsp struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.page = new ArrayList<EsOrderStatusField>(_list237.size);
          for (int _i238 = 0; _i238 < _list237.size; ++_i238)
          {
            EsOrderStatusField _elem239;
            _elem239 = new EsOrderStatusField();
            _elem239.read(iprot);
            struct.page.add(_elem239);
          }
        }
        struct.setPageIsSet(true);
      }
