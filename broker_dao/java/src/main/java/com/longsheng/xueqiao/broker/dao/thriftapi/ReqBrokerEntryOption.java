            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.brokerIds = new ArrayList<Integer>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  int _elem2;
                  _elem2 = iprot.readI32();
                  struct.brokerIds.add(_elem2);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.brokerIds != null) {
        if (struct.isSetBrokerIds()) {
          oprot.writeFieldBegin(BROKER_IDS_FIELD_DESC);
          {
            ...
            for (int _iter3 : struct.brokerIds)
            {
      ...
      if (struct.isSetBrokerIds()) {
        {
          ...
          for (int _iter4 : struct.brokerIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.brokerIds = new ArrayList<Integer>(_list5.size);
          for (int _i6 = 0; _i6 < _list5.size; ++_i6)
          {
            int _elem7;
            _elem7 = iprot.readI32();
            struct.brokerIds.add(_elem7);
          }
        }
        struct.setBrokerIdsIsSet(true);
      }
