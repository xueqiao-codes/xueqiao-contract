...
public class ReqCommodityMappingOption implements org.apache.thrift.TBase<ReqCommodityMappingOption, ReqCommodityMappingOption._Fields>, java.io.Serializable, Cloneable, Comparable<ReqCommodityMappingOption> {
  ...
  private _Fields optionals[] = {_Fields.SLED_COMMODITY_ID_LIST,_Fields.EXCHANGE,_Fields.COMMODITY_TYPE,_Fields.COMMODITY_CODE,_Fields.BROKER_ENTRY_ID,_Fields.MAP_IDS,_Fields.TECH_PLATFORM};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sledCommodityIdList = new ArrayList<Integer>(_list176.size);
                for (int _i177 = 0; _i177 < _list176.size; ++_i177)
                {
                  int _elem178;
                  _elem178 = iprot.readI32();
                  struct.sledCommodityIdList.add(_elem178);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mapIds = new ArrayList<Integer>(_list179.size);
                for (int _i180 = 0; _i180 < _list179.size; ++_i180)
                {
                  int _elem181;
                  _elem181 = iprot.readI32();
                  struct.mapIds.add(_elem181);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.sledCommodityIdList != null) {
        if (struct.isSetSledCommodityIdList()) {
          oprot.writeFieldBegin(SLED_COMMODITY_ID_LIST_FIELD_DESC);
          {
            ...
            for (int _iter182 : struct.sledCommodityIdList)
            {
      ...
      if (struct.mapIds != null) {
        if (struct.isSetMapIds()) {
          oprot.writeFieldBegin(MAP_IDS_FIELD_DESC);
          {
            ...
            for (int _iter183 : struct.mapIds)
            {
      ...
      if (struct.isSetSledCommodityIdList()) {
        {
          ...
          for (int _iter184 : struct.sledCommodityIdList)
          {
      ...
      if (struct.isSetMapIds()) {
        {
          ...
          for (int _iter185 : struct.mapIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.sledCommodityIdList = new ArrayList<Integer>(_list186.size);
          for (int _i187 = 0; _i187 < _list186.size; ++_i187)
          {
            int _elem188;
            _elem188 = iprot.readI32();
            struct.sledCommodityIdList.add(_elem188);
          }
        }
        struct.setSledCommodityIdListIsSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.mapIds = new ArrayList<Integer>(_list189.size);
          for (int _i190 = 0; _i190 < _list189.size; ++_i190)
          {
            int _elem191;
            _elem191 = iprot.readI32();
            struct.mapIds.add(_elem191);
          }
        }
        struct.setMapIdsIsSet(true);
      }
