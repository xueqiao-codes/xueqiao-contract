            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.relateCommodityCodes = new ArrayList<String>(_list104.size);
                for (int _i105 = 0; _i105 < _list104.size; ++_i105)
                {
                  String _elem106;
                  _elem106 = iprot.readString();
                  struct.relateCommodityCodes.add(_elem106);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.relateCommodityCodes != null) {
        if (struct.isSetRelateCommodityCodes()) {
          oprot.writeFieldBegin(RELATE_COMMODITY_CODES_FIELD_DESC);
          {
            ...
            for (String _iter107 : struct.relateCommodityCodes)
            {
      ...
      if (struct.isSetRelateCommodityCodes()) {
        {
          ...
          for (String _iter108 : struct.relateCommodityCodes)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.relateCommodityCodes = new ArrayList<String>(_list109.size);
          for (int _i110 = 0; _i110 < _list109.size; ++_i110)
          {
            String _elem111;
            _elem111 = iprot.readString();
            struct.relateCommodityCodes.add(_elem111);
          }
        }
        struct.setRelateCommodityCodesIsSet(true);
      }
