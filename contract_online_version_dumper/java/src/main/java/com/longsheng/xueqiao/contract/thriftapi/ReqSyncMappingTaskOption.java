            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.taskIds = new ArrayList<Integer>(_list80.size);
                for (int _i81 = 0; _i81 < _list80.size; ++_i81)
                {
                  int _elem82;
                  _elem82 = iprot.readI32();
                  struct.taskIds.add(_elem82);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.targetIds = new ArrayList<Integer>(_list83.size);
                for (int _i84 = 0; _i84 < _list83.size; ++_i84)
                {
                  int _elem85;
                  _elem85 = iprot.readI32();
                  struct.targetIds.add(_elem85);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.taskIds != null) {
        if (struct.isSetTaskIds()) {
          oprot.writeFieldBegin(TASK_IDS_FIELD_DESC);
          {
            ...
            for (int _iter86 : struct.taskIds)
            {
      ...
      if (struct.targetIds != null) {
        if (struct.isSetTargetIds()) {
          oprot.writeFieldBegin(TARGET_IDS_FIELD_DESC);
          {
            ...
            for (int _iter87 : struct.targetIds)
            {
      ...
      if (struct.isSetTaskIds()) {
        {
          ...
          for (int _iter88 : struct.taskIds)
          {
      ...
      if (struct.isSetTargetIds()) {
        {
          ...
          for (int _iter89 : struct.targetIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.taskIds = new ArrayList<Integer>(_list90.size);
          for (int _i91 = 0; _i91 < _list90.size; ++_i91)
          {
            int _elem92;
            _elem92 = iprot.readI32();
            struct.taskIds.add(_elem92);
          }
        }
        struct.setTaskIdsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.targetIds = new ArrayList<Integer>(_list93.size);
          for (int _i94 = 0; _i94 < _list93.size; ++_i94)
          {
            int _elem95;
            _elem95 = iprot.readI32();
            struct.targetIds.add(_elem95);
          }
        }
        struct.setTargetIdsIsSet(true);
      }
