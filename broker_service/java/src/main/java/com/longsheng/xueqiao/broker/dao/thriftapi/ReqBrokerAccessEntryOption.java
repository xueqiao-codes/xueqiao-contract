...
public class ReqBrokerAccessEntryOption implements org.apache.thrift.TBase<ReqBrokerAccessEntryOption, ReqBrokerAccessEntryOption._Fields>, java.io.Serializable, Cloneable, Comparable<ReqBrokerAccessEntryOption> {
  ...
  private _Fields optionals[] = {_Fields.BROKER_IDS,_Fields.PLATFORM,_Fields.ACCESS_STATUS,_Fields.ENTRY_IDS,_Fields.WORKING_STATUS,_Fields.ACCESS_NAME,_Fields.ENV,_Fields.PLATFORMS};
  ...
  public ReqBrokerAccessEntryOption setPlatforms(Set<com.longsheng.xueqiao.broker.thriftapi.BrokerPlatform> platforms) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.brokerIds = new ArrayList<Integer>(_list40.size);
                for (int _i41 = 0; _i41 < _list40.size; ++_i41)
                {
                  int _elem42;
                  _elem42 = iprot.readI32();
                  struct.brokerIds.add(_elem42);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.entryIds = new ArrayList<Integer>(_list43.size);
                for (int _i44 = 0; _i44 < _list43.size; ++_i44)
                {
                  int _elem45;
                  _elem45 = iprot.readI32();
                  struct.entryIds.add(_elem45);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.platforms = new HashSet<com.longsheng.xueqiao.broker.thriftapi.BrokerPlatform>(2*_set46.size);
                for (int _i47 = 0; _i47 < _set46.size; ++_i47)
                {
                  com.longsheng.xueqiao.broker.thriftapi.BrokerPlatform _elem48;
                  _elem48 = com.longsheng.xueqiao.broker.thriftapi.BrokerPlatform.findByValue(iprot.readI32());
                  struct.platforms.add(_elem48);
                }
                iprot.readSetEnd();
              }
      ...
      if (struct.brokerIds != null) {
        if (struct.isSetBrokerIds()) {
          oprot.writeFieldBegin(BROKER_IDS_FIELD_DESC);
          {
            ...
            for (int _iter49 : struct.brokerIds)
            {
      ...
      if (struct.entryIds != null) {
        if (struct.isSetEntryIds()) {
          oprot.writeFieldBegin(ENTRY_IDS_FIELD_DESC);
          {
            ...
            for (int _iter50 : struct.entryIds)
            {
      ...
      if (struct.platforms != null) {
        if (struct.isSetPlatforms()) {
          oprot.writeFieldBegin(PLATFORMS_FIELD_DESC);
          {
            ...
            for (com.longsheng.xueqiao.broker.thriftapi.BrokerPlatform _iter51 : struct.platforms)
            {
      ...
      if (struct.isSetBrokerIds()) {
        {
          ...
          for (int _iter52 : struct.brokerIds)
          {
      ...
      if (struct.isSetEntryIds()) {
        {
          ...
          for (int _iter53 : struct.entryIds)
          {
      ...
      if (struct.isSetPlatforms()) {
        {
          ...
          for (com.longsheng.xueqiao.broker.thriftapi.BrokerPlatform _iter54 : struct.platforms)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.brokerIds = new ArrayList<Integer>(_list55.size);
          for (int _i56 = 0; _i56 < _list55.size; ++_i56)
          {
            int _elem57;
            _elem57 = iprot.readI32();
            struct.brokerIds.add(_elem57);
          }
        }
        struct.setBrokerIdsIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.entryIds = new ArrayList<Integer>(_list58.size);
          for (int _i59 = 0; _i59 < _list58.size; ++_i59)
          {
            int _elem60;
            _elem60 = iprot.readI32();
            struct.entryIds.add(_elem60);
          }
        }
        struct.setEntryIdsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.platforms = new HashSet<com.longsheng.xueqiao.broker.thriftapi.BrokerPlatform>(2*_set61.size);
          for (int _i62 = 0; _i62 < _set61.size; ++_i62)
          {
            com.longsheng.xueqiao.broker.thriftapi.BrokerPlatform _elem63;
            _elem63 = com.longsheng.xueqiao.broker.thriftapi.BrokerPlatform.findByValue(iprot.readI32());
            struct.platforms.add(_elem63);
          }
        }
        struct.setPlatformsIsSet(true);
      }
